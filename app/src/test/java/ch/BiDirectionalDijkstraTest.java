...
public class BiDirectionalDijkstraTest {
    ...
    public void testShortestPath_basic() {
        Result<Integer> dist = BidirectionalDijkstra.shortestPath2(g, 1, 4);
    ...
    public void testShortestPath_directConnection() {
        Result<Integer> dist = BidirectionalDijkstra.shortestPath2(g, 1, 2);
    ...
    public void testShortestPath_noPathExists() {
        ...
        Result<Integer> dist = BidirectionalDijkstra.shortestPath2(disconnected, 1, 3);
        assertEquals("Unreachable vertex should return -1",-1, (long) dist.result );
    }
    @Test
    public void testShortestPath_sameNode() {
        Result<Integer> dist = BidirectionalDijkstra.shortestPath2(g, 1, 1);
